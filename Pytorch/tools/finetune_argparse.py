...
def get_argparse_bert_crf_one_stage():
    ...
    parser.add_argument("--epochs", default=200, type=int, help="Train epochs iterations.")
    parser.add_argument('--device',default='cuda',type=str, help="gpu cuda")
    parser.add_argument('--warmup_proportion', default=0.05, type=float, help="gpu cuda")
...
def get_argparse_bert_one_stage():
    ...
    parser.add_argument("--adam_epsilon", default=1e-8, type=float, help="Epsilon for Adam optimizer.")
    parser.add_argument("--epochs", default=40, type=int, help="Train epochs iterations.")
    parser.add_argument('--device',default='cuda',type=str, help="gpu cuda")
